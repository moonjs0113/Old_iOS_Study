...
class app0ViewController: UIViewController {
    var isZoom = false
    var imgOn: UIImage?
    var imgOff: UIImage?
    ...
    let timeSelector: Selector = #selector(app0ViewController.updateTime) // Timer function
    ...
    // 10장
    @IBAction func moveApp2View(_ sender: UIButton) {
        tabBarController?.selectedIndex = 0
    }
    @IBAction func moveApp1View(_ sender: Any) {
